...
| BitArray8/16/32/64                                     | Fixed-size unmanaged bitmasks providing allocation-free boolean arrays.                     |
...
| BlobCurve2/3/4                                         | 2D/3D/4D animation curves baked into fast Burst-compatible blobs.                           |
...
| Reference<T>                                           | Custom unmanaged pointer struct replacing Unity's BlobAssetReference constraints.           |
